package com.warpfuture.iot.api.console.aop;
...
public class LogAspect {
    ...
    @Pointcut(value = "execution(public * com.warpfuture.iot.api.console.service.*.*(..))")
    public void logServicePointcut() {
    }

    @Pointcut(value = "execution(public * com.warpfuture.iot.api.console.controller.*.*(..))")
    public void logControllerPointcut() {
    }

//    @Pointcut(value = "execution(public * com.warpfuture.iot.api.console.authfilter.TokenAuthFilter.doFilter(..))")
...
//    }
    ...
    private void log(JoinPoint joinPoint, String time, Object result) {
        ...
        logger.info("\nConsole: Time: {} {}: {}.{}(args: {}) return {}", LocalDateTime.now(), time, typeName, method, join, result);
    }
