...
public interface MerchantConsoleFeignService {

    @PostMapping(value = "/merchant/create")
    ResultVO createMerchant(@RequestBody Merchant merchant);

    @PostMapping(value = "/merchant/update")
    ResultVO updateMerchant(@RequestBody Merchant merchant);

    @PostMapping(value = "/merchant/delete")
    ResultVO deleteMerchant(@RequestBody Merchant merchant);
